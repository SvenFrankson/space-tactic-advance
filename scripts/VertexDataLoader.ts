class VertexDataLoader {
    ...
    private _vertexDatas: Map<string, Map<string, BABYLON.VertexData>>;

    constructor(scene: BABYLON.Scene) {
        this.scene = scene;
        this._vertexDatas = new Map<string, Map<string, BABYLON.VertexData>>();
    ...
    public async get(name: string): Promise<Map<string, BABYLON.VertexData>> {
        ...
        let vertexDatas: Map<string, BABYLON.VertexData> = new Map<string, BABYLON.VertexData>();
    ...
    public async getColorizedMultiple(
        ...
        color2Hex: string = "", // Replace green
        color3Hex: string = "" // Replace blue
    ): Promise<Map<string, BABYLON.VertexData>> {
        ...
        let colorizedVertexDatas: Map<string, BABYLON.VertexData> = new Map<string, BABYLON.VertexData>();
        vertexDatas.forEach(
            (vertexData, name) => {
